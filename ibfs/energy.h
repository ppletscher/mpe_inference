...
template <typename captype, typename tcaptype, typename flowtype> class Energy: public IBFSGraph<captype, tcaptype, flowtype>
{
	typedef IBFSGraph<captype, tcaptype, flowtype> GraphT;
public:
...
inline Energy<captype,tcaptype,flowtype>::Energy(int var_num_max, int edge_num_max, void (*err_function)(char *)) : IBFSGraph<captype, tcaptype, flowtype>(var_num_max, edge_num_max, err_function)
{
	Econst = 0;
